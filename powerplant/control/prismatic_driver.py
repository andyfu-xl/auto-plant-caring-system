...
class PrismaticDriver:
    ...
    def __init__(self, motor_pins, sensor_pins, position_range):
        ...
        self.distance_sensor = DistanceSensor(
            echo = sensor_pins[0],
            trigger = sensor_pins[1],
            max_distance=self.highest_position
            )
    ...
    def get_distance_to_target(self, target):
        ...
        print(f"Distance is estiamted to be {self.distance_sensor.distance * 100}cm")
        return target - (self.distance_sensor.distance * 100) #TODO: Fine tune this conversion
    def close(self):
        """Clean up IO"""
        self.motor.close()
